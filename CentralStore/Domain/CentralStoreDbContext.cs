      ...
      : base(options) { }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Product
            {
                ...
                Price = 1399.99m,
                MinPrice = 1299.99m,
                StoreId = Guid.Parse("0d9f1b3c-6d45-4a2d-ae2f-8d253b1ecf1d"),
            ...
            new Product
            {
                ...
                Price = 999.95m,
                MinPrice = 899.95m,
                StoreId = Guid.Parse("4c8a7f40-5bf5-4e39-90e3-6c8b5c8aa940"),
            ...
            new Product
            {
                ...
                Price = 1899.00m,
                MinPrice = 1799.00m,
                StoreId = Guid.Parse("8f7da5a1-22b6-4b7a-aa55-c38e1dfb0d1c"),
            ...
            new Product
            {
                ...
                Price = 4999.00m,
                MinPrice = 4599.00m,
                StoreId = Guid.Parse("1f2c3d4e-5f6a-7b8c-9d0e-1f2a3b4c5d6e"),
            ...
            modelBuilder.Entity<Customer>(product =>
            {
                product.HasKey(u => u.Id);
                product.Property(u => u.FirstName).IsRequired().HasMaxLength(100);
                product.Property(u => u.LastName).IsRequired().HasMaxLength(100);
                product.Property(u => u.Email).IsRequired().HasMaxLength(100);
                product.Property(u => u.Password).IsRequired().HasMaxLength(100);
